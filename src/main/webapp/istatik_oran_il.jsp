...
<header>
    <h2>İL BAZINDA BAZINDA BAŞARI ORANI</h2>
</header>
    ...
    <article>
        ...
        <table border=1>
            ...
            try{
                ...
                String sql ="select sehir , (sum(kabul_edilen_gun)/sum(toplam_gun))*100 as basari_orani  from staj_mulakat group by sehir;";
