...
<header>
    <h2>STAJ SONUC GORUNTULE NUMARAYA GORE</h2>
</header>
...
<section>
    ...
    <table border=1>
        ...
        try{
            ...
            String sql ="select s.ogrenci_no, n.isim, n.soyisim, n.ogretim, s.kurum, s.toplam_gun, s.kabul_edilen_gun from normal_ogrenci n , staj_mulakat s where s.ogrenci_no = n. ogrenci_no and n.ogrenci_no =" + ogrenci_no +";";
